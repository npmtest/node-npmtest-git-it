...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-git-it/node_modules/git-it/guide/buildpages.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-git-it/node_modules/git-it/guide/buildpages.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-git-it/node_modules/git-it/guide/</a> &#187; buildpages.js</div>
</div>
<div class="body">
...
var rawFiles = __dirname + (lang ? <span class="branch-0 cbranch-no" title="branch not covered" >'/raw-content-' + lang + '/' </span>: '/raw-content/')
var builtContent = __dirname + (lang ? <span class="branch-0 cbranch-no" title="branch not covered" >'/challenges-' + lang + '/' </span>: '/challenges/')
&nbsp;
// I can probably use glob better to avoid
// finding the right files within the files
glob("*.html", {cwd: rawFiles}, function (err, files) {
  thefiles = files
  <span class="missing-if-branch" title="if path not taken" >I</span>if (err) <span class="cstat-no" title="statement not covered" >return console.log(err)</span>
...
function buildPage(files) {
  files.forEach(function(file) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!file) <span class="cstat-no" title="statement not covered" >return</span>
&nbsp;
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (lang) {
<span class="cstat-no" title="statement not covered" >      content.body = translateLocale(content.body, lang)</span>
    }
...
function buildHeader(filename) {
  ...
  var content = {
    ...
    challengenumber: num,
    lang: lang ? <span class="branch-0 cbranch-no" title="branch not covered" >'-' + lang </span>: '',
    preurl: data.preurl,
...
function buildFooter(file) {
  ...
  var data = getPrevious(num)
  data.lang = lang ? <span class="branch-0 cbranch-no" title="branch not covered" >'-' + lang </span>: ''
...
function getPrevious(num) {
  ...
  thefiles.forEach(function(file) {
    if (pre === 0) {
      ...
      preurl = lang ? <span class="branch-0 cbranch-no" title="branch not covered" >'../index-' + lang + '.html' </span>: '../index.html'
    ...
    if (next === 12) {
      nextname = "Done!"
      nexturl = lang ? <span class="branch-0 cbranch-no" title="branch not covered" >'../index-' + lang + '.html' </span>: '../index.html'
